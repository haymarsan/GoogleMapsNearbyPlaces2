package com.kbzbank.ksma.googlemapsnearbyplaces;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Loading Offline JSON File

        try{
            JSONObject obj = new JSONObject(readJSONFromAsset());
            Log.d("TerminalID", obj.getString("obj"));
    ...
    public String readJSONFromAsset() throws JSONException{
        String json = null;
        try {
            InputStream is = getAssets().open("ATMLocation.json");
